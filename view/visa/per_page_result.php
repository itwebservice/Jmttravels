...
?>
        ...
        <div class="c-cardList type-hotel">
            <div class="c-cardListTable" role="button" data-toggle="collapse" href="#collapseExample<?= $visa_results_array[$visa_i]['country_id'] ?>" aria-expanded="false" aria-controls="collapseExample">
                <!-- *** Visa Card image *** -->
                    ...
                    <div class="c-compTabs">
                        <ul class="nav nav-tabs" id="myTab" role="tablist">
                            <li class="nav-item active">
                                <a class="nav-link active" id="visa_type_all-tab<?= $visa_results_array[$visa_i]['country_id'] ?>" data-toggle="tab" href="#visa_type_all<?= $visa_results_array[$visa_i]['country_id'] ?>" role="tab" aria-controls="visa_type_all" aria-selected="true">All</a>
                            </li>
                            <?php
                            if (sizeof($visa_types) > 0) {
                                for ($v = 0; $v < sizeof($visa_types); $v++) { ?>
                                    <li class="nav-item">
                                        <a class="nav-link" id="type-tab<?= $visa_results_array[$visa_i]['country_id'] . $v ?>" data-toggle="tab" href="#type<?= $visa_results_array[$visa_i]['country_id'] . $v ?>" role="tab" aria-controls="type" aria-selected="true"><?= $visa_types[$v]['visa_type'] ?></a>
                                    </li>
                            <?php
                                }
                            } ?>
