            ...
            <div class="c-cardListTable">
                ...
                <div class="cardList-info" role="button">
                    ...
                    <div class="dividerSection type-1 noborder">
                        <div class="divider s1" role="button" data-toggle="collapse" href="#collapseExample<?= $tours_result_array[$i]['package_id'] ?>" aria-expanded="false" aria-controls="collapseExample">
                            <a>
                            ...
                            <div class="infoSection">
                                <span class="cardInfoLine cust">
                                    ...
                                    <?= $tours_result_array[$i]['total_nights'] ?> Nights
                                    <?= $tours_result_array[$i]['total_days'] ?> Days
                ...
                <div class="cardList-accordian">
                    ...
                    <div class="c-compTabs">
                        <ul class="nav nav-tabs" id="myTab" role="tablist">
                            <li class="nav-item">
                                <a class="nav-link active" id="itinerary-tab" data-toggle="tab" href="#itinerary-tab<?= $tours_result_array[$i]['package_id'] ?>" role="tab" aria-controls="itinerary" aria-selected="true">Itinerary</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" id="travel-tab" data-toggle="tab" href="#travel-tab<?= $tours_result_array[$i]['package_id'] ?>" role="tab" aria-controls="travel" aria-selected="true">Travel & Stay</a>
                            </li>
                            <li class="nav-item">
                        ...
                        <div class="tab-content" id="myTabContent">
                                ...
                                ?>
                                    <script>
                                        setTimeout(function() {
                                            ...
                                            if ('<?= $offer_text ?>' != '') {
                                                document.getElementById("discount<?= $tours_result_array[$i]['package_id'] ?>")
                                                    .classList.remove("c-hide");
                                                document.getElementById("discount<?= $tours_result_array[$i]['package_id'] ?>")
                                                    .classList.add("c-show");

                                                document.getElementById(
                                                        "offer-currency-price<?= $tours_result_array[$i]['package_id'] ?>")
                                                    .innerHTML = '<?= $offer_amount ?>';
                                                document.getElementById(
                                                        "offer-currency-id<?= $tours_result_array[$i]['package_id'] ?>")
                                                    .innerHTML = '<?= $h_currency_id ?>';
                                                document.getElementById(
                                                        "discount_text<?= $tours_result_array[$i]['package_id'] ?>").innerHTML =
                                                    '<?= $offer_text ?>';
                                            } else {
                                                document.getElementById("discount<?= $tours_result_array[$i]['package_id'] ?>")
                                                    .classList.add("c-hide");
                                            }
                                        }, 50);
                                    </script>
                                    <!-- ***** Type List Card ***** -->
                                    ...
                                    <div class="cardListInfo-row">
                                        ...
                                        <?php for ($pi = 0; $pi < sizeof($tours_result_array[$i]['program_array']); $pi++) { ?>
                                            <div class="ListInfo-col">
                                                ...
                                                <div class="dayInfo">
                                                    <h5 class="h1">
                                                        <?= $tours_result_array[$i]['program_array'][$pi]['attraction'] ?></h5>
                                                            ...
                                                            <div class="flexGrid">
                                                                ...
                                                                <div class="gridItem styleForMobile M-m0">
                                                                    <div class="infoCard m5-btm">
                                                                        ...
                                                                        <span class="infoCard_price"><?= $tours_result_array[$i]['hotels_array'][$hotel_i]['nights'] ?>
                                                                            Nights</span>
                                                                    </div>
                                                                </div>
                                                            </div>
                            ...
                            <!-- **** Visa Details Start **** -->
                            <div class="tab-pane fade" id="visa-details-tab" role="tabpanel" aria-labelledby="visa-details-tab">
                                <div class="clearfix margin20-bottom">
                                    <h3 class="c-heading">Visa Details</h3>
                                </div>
                            </div>
                            <!-- **** Visa Details End **** -->
