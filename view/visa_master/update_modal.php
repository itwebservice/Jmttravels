        ...
        <form id="frm_visa_update">
          ...
          <div class="row">
            ...
            <div class="col-md-3 col-sm-6 col-xs-12 mg_bt_10">
              ...
              <input type="text" name="fees_b2b" class="form-control" title="Basic Amount B2B" placeholder="*Basic Amount B2B" id="fees_b2b" value="<?= $sq_visa['fees_b2b'] ?>" onchange="validate_balance(this.id);">

            </div>

            <div class="col-md-3 col-sm-6 col-xs-12 mg_bt_10">

              <input type="text" name="markup_b2b" class="form-control" placeholder="Markup cost B2B" title="Markup cost B2B" id="markup_b2b" value="<?= $sq_visa['markup_b2b'] ?>" onchange="validate_balance(this.id);">
...
<script>
  ...
  function upload_user_pic_attch() {
    ...
    if (file_url != '') {
      var file_text = 'Uploaded';
    } else {
      var file_text = 'Upload Form1';
    }
  ...
  $(function() {
    ...
    $('#frm_visa_update').validate({
      ...
      submitHandler: function(form) {
        ...
        var fees_b2b = $("#fees_b2b").val();

        var markup_b2b = $("#markup_b2b").val();
