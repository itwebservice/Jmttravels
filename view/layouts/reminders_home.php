...
$sq_b2b = mysqli_num_rows(mysqlQuery("select * from remainder_status where remainder_name='b2b_credit_payment_overdue' and date='$today'"));
//Inventory
$sq_hotel_inv = mysqli_num_rows(mysqlQuery("select * from remainder_status where remainder_name='hotel_inventory' and date='$today'"));
$sq_exc_inv = mysqli_num_rows(mysqlQuery("select * from remainder_status where remainder_name='excursion_inventory' and date='$today'"));

$sq_birt_re = mysqli_num_rows(mysqlQuery("select * from remainder_status where remainder_name='emp_birthday' and remainder_name='cust_birthday' and date='$today'"));

$sq_hap_jou = mysqli_num_rows(mysqlQuery("select * from remainder_status where remainder_name='git_happy_journey' and remainder_name='fit_happy_journey' and date='$today'"));

$sq_chk_pen = mysqli_num_rows(mysqlQuery("select * from remainder_status where remainder_name='checklist_git_pending_remainder' and remainder_name='checklist_fit_pending_remainder' and date='$today'"));

$sq_grp_pen = mysqli_num_rows(mysqlQuery("select * from remainder_status where remainder_name='git_payment_pending_remainder' and date='$today'"));

$sq_fit_pen = mysqli_num_rows(mysqlQuery("select * from remainder_status where remainder_name='fit_payment_pending_remainder'  and date='$today'"));

$sq_visa_pen = mysqli_num_rows(mysqlQuery("select * from remainder_status where remainder_name='visa_payment_pending_remainder'  and date='$today'"));

$sq_passport_pen = mysqli_num_rows(mysqlQuery("select * from remainder_status where remainder_name='passport_payment_pending_remainder'  and date='$today'"));

$sq_air_pen = mysqli_num_rows(mysqlQuery("select * from remainder_status where remainder_name='air_payment_pending_remainder'  and date='$today'"));
$sq_misc_pay = mysqli_num_rows(mysqlQuery("select * from remainder_status where remainder_name='misc_payment_pending_remainder'  and date='$today'"));

$sq_exc_pen = mysqli_num_rows(mysqlQuery("select * from remainder_status where remainder_name='excursion_payment_pending_remainder' and date='$today'"));

$sq_train = mysqli_num_rows(mysqlQuery("select * from remainder_status where remainder_name='train_payment_pending_remainder'  and date='$today'"));

$sq_hotel= mysqli_num_rows(mysqlQuery("select * from remainder_status where remainder_name='hotel_payment_pending_remainder'  and date='$today'"));

$sq_car= mysqli_num_rows(mysqlQuery("select * from remainder_status where remainder_name='car_payment_pending_remainder' and date='$today'"));

$sq_vendor= mysqli_num_rows(mysqlQuery("select * from remainder_status where remainder_name='vendor_payment_pending_remainder'  and date='$today'"));

$sq_git_fed= mysqli_num_rows(mysqlQuery("select * from remainder_status where remainder_name='git_feedback_remainder' and date='$today'"));

$sq_fit_fed= mysqli_num_rows(mysqlQuery("select * from remainder_status where remainder_name='fit_feedback_remainder' and date='$today'"));

$sq_hotel_tarrif= mysqli_num_rows(mysqlQuery("select * from remainder_status where remainder_name='hotel_tarrif_remainder' and date='$today'"));

$sq_emp_anni= mysqli_num_rows(mysqlQuery("select * from remainder_status where remainder_name='emp_anniversary' and date='$today'"));

$sq_user_visa= mysqli_num_rows(mysqlQuery("select * from remainder_status where remainder_name='user_visa_renewal' and date='$today'"));

$sq_tax_pay= mysqli_num_rows(mysqlQuery("select * from remainder_status where remainder_name='tax_pay_raminder' and date='$today'"));

$sq_cust_passport= mysqli_num_rows(mysqlQuery("select * from remainder_status where remainder_name='customer_passport_renewal' and date='$today'"));

$sq_cust_feedback= mysqli_num_rows(mysqlQuery("select * from remainder_status where remainder_name='customer_feedback' and date='$today'"));

$sq_cust_fit_feedback = mysqli_num_rows(mysqlQuery("select * from remainder_status where remainder_name='fit_customer_feedback' and date='$today'"));
?>
