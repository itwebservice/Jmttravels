...
function foo(tableID, quot_table_id, rowCounts) {
  ...
  if (
    ...
    row.cells[2].childNodes[0].setAttribute(
      "onchange",
      "get_to_datetime(id,'" + row.cells[8].childNodes[0].id + "')"
    );
    row.cells[8].childNodes[0].setAttribute(
      "onchange",
  ...
  if (tableID == "tbl_package_transport_infomration") {
    ...
    row.cells[7].childNodes[0].setAttribute("id", "no_vehicles" + foo.counter);
  ...
  if (
    ...
    row.cells[10].childNodes[0].setAttribute("id", "package_id-" + foo.counter);
    row.cells[11].childNodes[0].setAttribute(
      "id",
      "pickup_type-" + foo.counter
    );
    row.cells[12].childNodes[0].setAttribute("id", "drop_type" + foo.counter);
  ...
  if (tableID == "tbl_package_tour_quotation_dynamic_costing") {
    ...
    row.cells[8].childNodes[1].setAttribute(
      "id",
    ...
    row.cells[10].childNodes[1].setAttribute(
      "id",
      "service_tax_subtotal-" + foo.counter
    );
    row.cells[11].childNodes[1].setAttribute(
      "id",
    ...
    row.cells[13].childNodes[1].setAttribute("id", "package_id" + foo.counter);
    ...
    if (row.cells[12]) {
      row.cells[12].style.display = "hidden";
    }
  ...
  if (tableID == "tbl_package_tour_quotation_dynamic_train") {
    ...
    row.cells[5].childNodes[0].style.width = "180px";
    var today = new Date();
    var dd = today.getDate();
    var mm = today.getMonth() + 1; //January is 0;
    var yyyy = today.getFullYear();
    ...
    row.cells[6].childNodes[0].style.width = "180px";
    var today = new Date();
    var dd = today.getDate();
    var mm = today.getMonth() + 1; //January is 0!
